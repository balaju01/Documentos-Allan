...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_animacion_t, stringdata) + ofs \
...
const QMetaObject animacion::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_animacion.data,
      qt_meta_data_animacion,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_animacion.stringdata))
